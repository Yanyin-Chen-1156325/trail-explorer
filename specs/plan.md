...
The application will use a React frontend, an ASP.NET Core Web API backend, and a SQLite database.

The frontend will handle trail discovery, check-ins, dashboard views, achievements, theme switching, and real-time user feedback.

The backend will expose REST APIs for authentication, trail data, check-ins, achievements, notifications, and leaderboard data.

Detailed architecture, data model, security design, caching design, logging design, and deployment decisions are documented in `specs/system-design.md`.
